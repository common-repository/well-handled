...
use \blobfolio\wp\wh\vendor\Handlebars\Loader\StringLoader;
use \blobfolio\wp\wh\vendor\Handlebars\Cache\Dummy;
...
class Handlebars
{
     ...
     */
    private $_templateClass = 'blobfolio\\wp\\wh\\vendor\\Handlebars\\Template';
    ...
    {
        if (!is_a($class, 'blobfolio\\wp\\wh\\vendor\\Handlebars\\Template', true)) {
            throw new \InvalidArgumentException(
                sprintf(
